...
CELEBRITY_DICTIONARY_PATH = os.environ.get('CELEBRITY_DICTIONARY_PATH', "src/celebrities_names.txt")
...
def get_transcript(inputaudio_file_path, audio_duration_sec, audio_json_file_path):
    ...
    for i in range(int(audio_duration_sec) - SR_SHIFT_SEC):
        with sample_audio as audio_file:
            audio_content = recognizer.record(audio_file, offset=i, duration=duration)
            try:
